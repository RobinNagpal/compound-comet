...
const marketAdminAddress = '0x7e14050080306cd36b47DE61ce604b3a1EC70c4e';  // Need to verify this address

const localTimelockAddress = '0x6d903f6003cca6255D85CcA4D3B5E5146dC33925';  // currently using mainnet Timelock
...
const communityMultiSigAddress = '0x008a4C5448ac1Df676d6F39A0C6F13b21b189389 ';

const configuratorProxyAddress = '0xc28aD44975C614EaBe0Ed090207314549e1c6624';
const cometProxyUsdcAddress = '0xAec1F48e02Cfb822Be958B68C7957156EB3F0b6e';
const cometProxyWethAddress = '0x2943ac1216979aD8dB76D9147F64E61adc126e96';

export default migration('1729700340_gov_market_updates', {
  prepare: async () => {
    return {};
  },
