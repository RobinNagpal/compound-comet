...
library ChainAddresses {
    ...
    address constant public MAINNET_MARKET_ADMIN = address(0);
    ...
    address constant public POLYGON_MARKET_ADMIN = address(0);
    ...
    address constant public ARBITRUM_MARKET_ADMIN = address(0);
    ...
    address constant public BASE_MARKET_ADMIN = address(0);
    ...
    address constant public SCROLL_MARKET_ADMIN = address(0);
    ...
    address constant public OPTIMISM_MARKET_ADMIN = address(0);
